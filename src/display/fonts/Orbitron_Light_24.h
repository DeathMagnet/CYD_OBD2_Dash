...
// (Fonts/Custom/Orbitron_Light_24.h, created by http://oleddisplay.squix.ch/)
...
//  - '`' (backtick) yOffset corrected from -24 to -17 (matches the
//    apostrophe's offset; -24 was a font-generation data bug that made
//    this one punctuation mark taller than every capital letter).
//  - yAdvance corrected from 24 to 28: the font's real max ascent (20, from
//    '$'/'|') plus max descent (6, from 'g'/'j'/'p'/'q'/'y') is 26px, 2px
//    taller than the declared 24 was accounting for. TFT_eSPI sizes text
//    redraw/erase boxes off yAdvance, so the too-small original value left
//    ghosting artifacts behind moving digits (see gauge_widgets.cpp
//    drawFieldText()).
const uint8_t Orbitron_Light_24_Fixed_Bitmaps[] PROGMEM = {
...
const GFXglyph Orbitron_Light_24_Fixed_Glyphs[] PROGMEM = {
// bitmapOffset, width, height, xAdvance, xOffset, yOffset
	  ...
	  {  1767,   1,   1,   1,    0,    0 }, // '^'
	  {  1768,  17,   2,  20,    1,    0 }, // '_'
	  {  1773,   4,   3,   6,    0,  -17 }, // '`'  (fixed: was -24, matches apostrophe)
...
const GFXfont Orbitron_Light_24_Fixed PROGMEM = {
(uint8_t  *)Orbitron_Light_24_Fixed_Bitmaps,(GFXglyph *)Orbitron_Light_24_Fixed_Glyphs,0x20, 0x7D, 28};
