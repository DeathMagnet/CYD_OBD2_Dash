// Vendored from TFT_eSPI's bundled "Custom" example font
// (Fonts/Custom/Orbitron_Light_32.h, created by http://oleddisplay.squix.ch/)
// so this project doesn't depend on the exact contents of whatever
// Bodmer/TFT_eSPI.git currently has checked out, and so the metric fixes
// below survive a library reinstall.
//
// Fixes applied vs the upstream file:
//  - '`' (backtick) yOffset corrected from -33 to -24 (matches the
//    apostrophe's offset; -33 was a font-generation data bug that made
//    this one punctuation mark taller than every capital letter).
//  - yAdvance corrected from 32 to 38: the font's real max ascent (27,
//    from '$') plus max descent (8, from 'g'/'j'/'p'/'q'/'y') is 35px,
//    3px taller than the declared 32 was accounting for. TFT_eSPI sizes
//    text redraw/erase boxes off yAdvance, so the too-small original
//    value left ghosting artifacts behind moving digits (see
//    gauge_widgets.cpp drawFieldText(), used for the RPM/Speed readouts).
const uint8_t Orbitron_Light_32_Fixed_Bitmaps[] PROGMEM = {
...
const GFXglyph Orbitron_Light_32_Fixed_Glyphs[] PROGMEM = {
// bitmapOffset, width, height, xAdvance, xOffset, yOffset
	  ...
	  {  3242,   1,   1,   1,    0,    0 }, // '^'
	  {  3243,  23,   2,  27,    2,    1 }, // '_'
	  {  3249,   4,   4,   8,    1,  -24 }, // '`'  (fixed: was -33, matches apostrophe)
...
const GFXfont Orbitron_Light_32_Fixed PROGMEM = {
(uint8_t  *)Orbitron_Light_32_Fixed_Bitmaps,(GFXglyph *)Orbitron_Light_32_Fixed_Glyphs,0x20, 0x7D, 38};
