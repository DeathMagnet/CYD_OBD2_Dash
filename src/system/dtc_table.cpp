...
const DtcDefinition kDtcTable[] = {
    ...
    {"P0014", "B Camshaft Position - Timing Over-Advanced or System Mustang Performance"},
    ...
    {"P0630", "IN Not Programmed or Incompatible - ECM/PCM"},
...
const size_t kDtcTableCount = sizeof(kDtcTable) / sizeof(kDtcTable[0]);
